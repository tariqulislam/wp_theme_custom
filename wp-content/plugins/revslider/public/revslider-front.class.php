...
class RevSliderFront extends RevSliderBaseFront{
	...
	public static function onAddScripts(){
		...
		if($load_all_javascript !== 'off'){ //if on, load all libraries instead of dynamically loading them
			wp_enqueue_script('revmin-actions', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.actions.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-carousel', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.carousel.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-kenburn', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.kenburn.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-layeranimation', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.layeranimation.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-migration', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.migration.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-navigation', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.navigation.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-parallax', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.parallax.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-slideanims', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.slideanims.min.js', 'tp-tools', $slver, $ft);
			wp_enqueue_script('revmin-video', RS_PLUGIN_URL .'public/assets/js/extension/revolution.extension.video.min.js', 'tp-tools', $slver, $ft);
		}
