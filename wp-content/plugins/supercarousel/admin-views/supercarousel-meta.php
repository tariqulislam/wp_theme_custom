...
<ul class="sprcrsl-admin">
    ...
    <li class="w8">
        ...
        <span id="supercontentcarouseldiv"<?php echo (in_array($sourcetype, array('image', ''))) ? ' style="display: none;"' : ''; ?>>
            ...
            <br /><br />
            <span>Number of Slides <input type="text" name="super[numslides]" value="<?php echo $numslides; ?>" class="smallip" /></span>
            <select class="sel1" name="super[orderby]">
                <option value="none"<?php echo ($orderby == 'none') ? ' selected="selected"' : ''; ?>>Order By</option>
                <option value="ID"<?php echo ($orderby == 'ID') ? ' selected="selected"' : ''; ?>>ID</option>
                <option value="author"<?php echo ($orderby == 'author') ? ' selected="selected"' : ''; ?>>Author</option>
                ...
                <option value="type"<?php echo ($orderby == 'type') ? ' selected="selected"' : ''; ?>>Type</option>
                <option value="date"<?php echo ($orderby == 'date') ? ' selected="selected"' : ''; ?>>Date</option>
                <option value="modified"<?php echo ($orderby == 'modified') ? ' selected="selected"' : ''; ?>>Modified</option>
                <option value="parent"<?php echo ($orderby == 'parent') ? ' selected="selected"' : ''; ?>>Parent</option>
                <option value="comment_count"<?php echo ($orderby == 'comment_count') ? ' selected="selected"' : ''; ?>>Comment Count</option>
                <option value="menu_order"<?php echo ($orderby == 'menu_order') ? ' selected="selected"' : ''; ?>>Menu Order</option>
            </select>
            <select class="sel1" name="super[displayorder]">
                <option value="ASC"<?php echo ($displayorder == 'ASC') ? ' selected="selected"' : ''; ?>>ASC</option>
                <option value="DESC"<?php echo ($displayorder == 'DESC') ? ' selected="selected"' : ''; ?>>Desc</option>
            </select>
            ...
            <span class="note"><br />Note: Number of Slides 0 to display all slides</span>
        </span>
    </li>
</ul>
...
<ul class="sprcrsl-admin">
    <li class="w10 satitle">
        <strong>Slide Dimensions</strong>
...
<ul class="sprcrsl-admin">
    <li class="w10 satitle">
        <strong>Slide Dimensions in Mobile/Tablet </strong>
