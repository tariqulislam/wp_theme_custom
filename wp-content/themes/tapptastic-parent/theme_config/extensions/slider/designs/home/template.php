...
<!-- .Main Slider -->
<div id="main-slider" class="main-slider carousel slide  home-slider<?php echo $uniq;?> invisible">
    <div class="carousel-inner">
        <?php $k = 0; foreach ($view_variables['slides'] as $slide):?>
            <?php $class = ($k == 0) ? 'active' : '';?>
        <div class="item <?php echo $class;?>" style="<?php echo $bg;?>">
                <div class="carousel-caption">
                    <h2 data-animate-in="fadeInLeft" data-animate-out="fadeOutRight"><?php echo $slide['slide_title'];?></h2>
                    <div class="slider_text">
                        <?php echo do_shortcode($slide['slide_content']);?>
                    </div>
                </div>
                <?php if($slide['slide_type'] == 'img'):?>
                    <div class="slider-caption iPhone-apps" data-animate-in="fadeInUpSmall" data-animate-out="fadeOutDown"><img src="<?php echo $slide['slide_src'];?>" alt=""></div>
                <?php else:?>
                                ...
                                <script>
                                    jQuery(document).ready(function(){
                                        ...
                                        videojs("video<?php echo $k;?>", {
                                                ...
                                                jQuery('.home-slider<?php echo $uniq;?>').on('slid.bs.carousel', function () {
                                                    resizeVideoJS();
                                                })
                                            });
                                            });
    ...
    <ol class="carousel-indicators">
        <?php $c = 0; foreach ($view_variables['slides'] as $slide):?>
            <?php $class = ($c == 0) ? 'class="active"' : '';?>
            <li data-target="#main-slider" data-slide-to="<?php echo $c;?>" <?php echo $class;?>></li>
        <?php $c++; endforeach; ?>
    </ol>
</div>
<!--/ .Main Slider -->
