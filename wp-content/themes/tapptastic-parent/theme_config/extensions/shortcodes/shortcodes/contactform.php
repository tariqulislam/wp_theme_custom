...
function tf_contactform_shortcode($atts){
    ...
    if($form_exists){
        ...
        $out .='<h3 class="contact-title" id="header_message">'.urldecode($form['header_message']).'</h3>
        ...
        $out.='<form id="contactForm" action="" method="post" class="ajax_form contact-form contactForm" name="contactForm"><div class="row">';
        ...
        $fcount = 1;
        $margin=20;
        $out_left = '<div class="col-sm-8 clearfix">';
        ...
        $out_left .= '</div>';
        $out_right .= '<div class="form-submit"><span class="btn btn-transparent btn-small"><input type="submit" id="send_form" class="btn-submit2 " name="submit" title="Submit mesage" value="'. $form['submit_mess'].'" /><img id="sending_img" src="'.$surse.'" alt="" style="margin-left:50px; margin-bottom:-6px; display: none; border:0;" /></span></div></div>';
        $out .= $out_left.$out_right;
        $out .='</div></form><div class="clear"></div></div></div></div></div>';
...
function textarea($input,$form_input){
    return "<div class='contact-form-text' style='".$form_input['floating']."'>
