...
function tf_reservationform_shortcode($atts){
    ...
    if($form_exists){
        $out .='<div class="row inner">
                    <div class="col-sm-12 col-md-8 col-md-offset-2">
                        <div class="contact-send">
                        <div class="add-comment" id="addcomments"><h3 id="header_message" class="contact-title">'.urldecode($form['header_message']).'</h3>';
        ...
        $out.='<form id="reservationForm" action="" method="post" class="contactForm reservationForm" name="reservationForm"><div class="row">';
        ...
        $fcount = 1;
        $margin=20;
        $out_left = '<div class="col-sm-8">';
        $out_right = '<div class="col-sm-4">';
        foreach($colmuns as $form_input){
            ...
            if ($sidebar_position == 'full')
            {
                if($is_preview)
                    ...
                    $ewidth=490-$lines[$element_line]+$margin;
            }
            else {
                $ewidth=490-$lines[$element_line]+$margin;
            }
        ...
        $out_left .= '</div>';
        $out_right .= '<div class="form-submit">
            <span class="btn btn-transparent btn-small">
                <input type="submit" id="send_reservation" class="btn-submit2" name="submit" title="Submit mesage" value="'. urldecode($form['submit_mess']).'" />
                <img id="sending_img" src="'.$surse.'" alt="Sending" style="margin-left:50px; margin-bottom:-6px; display: none; border:0;" />
            </span>
            </div></div>';
...
function res_text($input,$form_input){
    ...
    return "<div class='contact-form-name ".$form_input['classes']."' style='width:".($form_input['ewidthpx']+$dist)."px; ".$form_input['floating']."'>
...
function res_textarea($input,$form_input){
    return "<div class='contact-form-text ".$form_input['classes']."' style='".$form_input['floating']."'>
...
function res_radio($input,$form_input){
    ...
    $output="<div class='contact-form-name radio ".$form_input['classes']."' style='width:".($form_input['ewidthpx']+$dist)."px;".$form_input['floating']."'>
...
function res_datepicker($input,$form_input){
    ...
    $output="<div class='contact-form-name ".$form_input['classes']."' style='width:".($form_input['ewidthpx']+$dist+$dist_select)."px; ".$form_input['floating']."'>
...
function res_checkbox($input,$form_input){
    ...
    $output = "<div class='contact-form-name checkbox ".$form_input['classes']."' style='width:".($form_input['ewidthpx']+$dist)."px;".$form_input['floating']."'>
...
function res_captcha($input,$form_input){
    ...
    $out="<div class='contact-form-name captcha ' style='".$form_input['floating']."'>
...
function res_select($input,$form_input){
    ...
    $out = "<div class='contact-form-name ".$form_input['classes']."' style='width:".($form_input['ewidthpx']+$dist)."px; ".$form_input['floating']."'>
