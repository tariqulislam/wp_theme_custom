...
class TFuse_Widget_Categories extends WP_Widget {
    ...
    function widget( $args, $instance ) {
        ...
        <div class="hover-search">
            <a href="#" class="btn-search"><?php _e('Search OUR BLOG','tfuse'); ?><span class="icon-stack"><i class="icon-circle-blank icon-stack-base"></i><i class="icon-search"></i></span></a>
            <form method="get" id="searchform5" action="<?php echo home_url( '/' ) ?>" class="clearfix">
                <input class="inputField" name="s" id="s" value="" placeholder="<?php _e('Search this blog','tfuse'); ?>" type="text">
