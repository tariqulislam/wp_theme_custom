...
function tf_contactform_shortcode($atts){
    ...
    if($form_exists){
        ...
        <span class="btn btn-transparent btn-small">
            <input type="submit" id="send_form" class="btn-submit2 " name="submit" title="Submit mesage" value="'. $form['submit_mess'].'" />
                <img id="sending_img" src="'.$surse.'" alt="" style="margin-left:50px; margin-bottom:-6px; display: none; border:0;" /></span>
        </div></div>';
